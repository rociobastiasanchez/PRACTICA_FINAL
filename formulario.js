...
function postal () {
    ...
    if (codigopostalusuario.length < 5 ){
        ...
        swal("El código postal no corresponde con la localidad. Revise sus datos teniendo en cuenta que las localidades se deben escribir la primera letra en mayúsculas, sin acentos y sin eñes (Ejemplo: La Corunya).", {
            icon: 'error',
        });
        var rojo = document.getElementById("rojo");
        rojo.textContent = "El código postal o la localidad son incorrectos. Revise sus datos teniendo en cuenta que las localidades se deben escribir la primera letra en mayúsculas, sin acentos y sin eñes (Ejemplo: La Corunya).";
